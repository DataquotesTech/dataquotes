          ...
          <div className="px-10 py-2 h-full flex-col gap-8 items-center justify-center">
            ...
            <div className="bg-black/5 backdrop-blur-3xl rounded-4xl border-2 border-neutral-900 flex flex-col gap-2 items-center justify-center text-neutral-200 ">
              ...
              >
                ...
                <div  className={`h-full w-1/5  flex flex-col items-start justify-start gap-4  ${hostGrotesk.className} `}>
                  <h3
                ...
                <div  className={`h-full w-2/5  flex flex-col items-start justify-start gap-4  ${hostGrotesk.className} `}>
                  <h3
                  ...
                  <div className="flex flex-col items-start justify-start gap-2">
                    <h3 className="text-neutral-300">DataQuotes EdTech Pvt Ltd</h3>
                    <p className="text-xs flex items-start gap-2 justify-start text-neutral-400"><span className="text-md"><FaLocationDot /></span>3rd Floor, 14-40A, Vaikuntapuram Arch Rd, Dhanalakshmi Nagar, Vk Puram, Tirupati, Andhra Pradesh 517502</p>
                  
                  </div>
                  <div className="flex flex-col items-start justify-start gap-2">
                    <h3 className="text-neutral-300">DataQuotes EdTech Pvt Ltd</h3>
                    <p className="text-xs flex items-start gap-2 justify-start text-neutral-400"><span className="text-md"><FaLocationDot /></span>2nd Floor, VSM Building, Destiny Tech Services, Renigunta Rd, beside NEXA Showroom, Tirupati, Andhra Pradesh 517501</p>
